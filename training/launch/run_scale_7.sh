...
# TRAIN_DATA_PATH="$REPO_ROOT/data/bfcl_rl_training_7_per_workflow.parquet"
# TEST_DATA_PATH="$REPO_ROOT/data/bfcl_rl_training_7_per_workflow.parquet"

TRAIN_DATA_PATH="$REPO_ROOT/data/scale_bfcl_rl_7_per_workflow.parquet"
