...
EXPERIMENT_NAME=$MODEL_PATH-$ALGORITHM-$REWARD_TAG-n$ROLLOUT_N-lr$LEARNING_RATE-bs$BATCH_SIZE-mbs$MINI_BATCH_SIZE-kl$KL_COEF-scale3
...
# TRAIN_DATA_PATH="$REPO_ROOT/data/bfcl_rl_training_1_per_workflow.parquet"
# TEST_DATA_PATH="$REPO_ROOT/data/bfcl_rl_training_1_per_workflow.parquet"

TRAIN_DATA_PATH="$REPO_ROOT/data/scale_bfcl_rl_1_per_workflow.parquet"
...
# : ${MLFLOW_S3_BUCKET:="s3://sfai-2025-summer-intern/jycheng/mlflow_traces"}
