...
EXPERIMENT_NAME=$MODEL_PATH-$ALGORITHM-$REWARD_TAG-n$ROLLOUT_N-lr$LEARNING_RATE-bs$BATCH_SIZE-mbs$MINI_BATCH_SIZE-kl$KL_COEF-scale5
...
TRAIN_DATA_PATH="$REPO_ROOT/data/scale_bfcl_rl_5_per_workflow.parquet"
